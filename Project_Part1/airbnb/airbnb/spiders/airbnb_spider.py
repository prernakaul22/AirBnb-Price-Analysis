...
# to start the spider, go to the top leve of project and run command: scrapy crawl airbnb_spider
#################################  IMPORTANT  ##################################################
...
class AirbnbSpider(Spider):
	...
	def parse(self, response):
		...
		URL_frag1 = r"https://www.airbnb.com/s/New-York-City--NY--United-States/homes?refinement_paths%5B%5D=%2Fhomes&allow_override%5B%5D=&price_max="
		...
		#lastURL = r"https://www.airbnb.com/s/New-York-City--NY--United-States/homes?refinement_paths%5B%5D=" + r"%2F" + r"homes&allow_override%5B%5D=&ne_lat=40.819590026706805&ne_lng=-73.91768915134355&sw_lat=40.692268164540494&sw_lng=-74.05330163913652&zoom=12&search_by_map=true&price_min=999&s_tag=D2-Gtzq2"

		lastURL = r"https://www.airbnb.com/s/New-York-City--NY--United-States/homes?refinement_paths%5B%5D=" + r"%2F" + r"homes&checkin=2018-10-07&checkout=2018-10-08&adults=1&children=0&infants=0&guests=1&query=New%20York%20City%2C%20NY%2C%20United%20States&allow_override%5B%5D=&s_tag=6ttJdMmX"
